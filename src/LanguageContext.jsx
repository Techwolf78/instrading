...
const translations = {
  en: {
    ...
    bioHeadOfBusiness:
      "Serves as an Advisor at INS Group, contributing strategic guidance to the company's commercial and operational direction across Afghanistan. With hands-on experience in business development and delivery management, he brings a strong understanding of cross-sector project execution, institutional coordination, and operational management. Alongside his advisory role at INS, he oversees business planning, partner engagement, and day-to-day commercial activities at Gryphon Academy.",
    bioDirectorSales:
      "Seasoned sales and marketing professional with a proven track record in market development and brand strategy. Known for her visionary leadership, exceptional time management, and ability to guide teams through high-pressure environments. She serves as an Advisor in Sales and Marketing at INS Group, offering strategic counsel on market development, brand positioning, and connecting Afghan trade with Indian and global buyers.",
    bioAdvisor:
